...
namespace WindowsTorWrapper
{
   ...
   private void button5_Click(object sender, EventArgs e)
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs c)
        {
            ...
            string scriptfirewallrule = string.Format("netsh advfirewall firewall add rule name = 'Tor Relay' dir =inbound action = allow program = 'C:\\ProgramData\\chocolatey\\lib\\tor\\tools\\Tor\\tor.exe' Enable = yes");
